<?php
	...
	$gid = empty($_GET['gid']) ? 0 : $_GET['gid'];
        $group_class_type=MWDB::get_group_class_types_id($gid);
        
        $is_sat_class_subscribed = is_sat_class_subscribed($group_class_type->class_type_id);
//        var_dump($is_sat_class_subscribed);
//        die();
	$gname = '';
	...
	else
	{
		...
		if(isset($_POST['request-grading'])) {
			...
			if(ik_request_worksheet_grading($hrid, $hid, $current_user_id)) {
				...
				$row_hw = MWDB::get_homework_assignment_by_id($hid);
				$roles = array("r-teacher","q-teacher","mr-teacher","mq-teacher");

				$subject_email = 'The subject of tutoring, Title: '.$row_hw->name;
				...
				$message .= '<p>The tutoring language requested: English</p>';
				$message .= '<p>The subject of tutoring, Title: '.$row_hw->name.'</p></br>';
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <hr>
                                    <h4 class="text-warning1" id="text-warning1"></h4>
                                </div>
      ...
      <div class="modal-content">
		...
		<?php
			...
			ik_enqueue_js_messages('point_err', sprintf(__('Your current points is <strong>%d</strong> pts. You don\'t have enough points to request grading for this homework', 'iii-dictionary'), ik_get_user_points($current_user_id)));
                        ...
                        ik_enqueue_js_messages('sub_req_err', __('Please subscribe SAT Preparation', 'iii-dictionary').' - '.$group_class_type->html.__(' to start', 'iii-dictionary'));
...
<div id="require-modal" class="modal fade modal-red-brown" aria-hidden="true">
	<div class="modal-dialog">
	  <div class="modal-content">
		<div class="modal-header">
			<a href="#" data-dismiss="modal" aria-hidden="true" class="close"></a>
