...
<div class="row">
    <div class="col-md-12 css-pad-left0-desktop mb-form-login">
        ...
        ?>
                ...
                <form action="<?php echo locale_home_url() ?>/?r=login" name="loginform" method="post">
                    <div class="row width-content" style="width:875px; margin:auto !important">
                        <div class="col-sm-6 css-pad-left0-tablet">
                        ...
                        <div class="col-sm-6 css-pad-right0-tablet">
                            <div class="form-group">
                        ...
                        <div class="clearfix"></div>
                        <div class="col-sm-12 css-pad-left0-tablet" style="margin-top: 35px;">
...
<!--                <div class="row">
                ...
                <script>
                    (function ($) {
                        ...
                        jQuery('#span-title').html("Enter email address and click button for a new password.");
                        });
                    (jQuery);
                </script>
                <form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url(network_site_url('?r=login&action=forgotpassword')); ?>" method="post">
                    <div class="row" >
                        <div class="col-md-6 col-sm-6 css-pad-left0-desktop css-width-50-tablet">
                            <div class="form-group">
                                <label for="user_login" ><?php _e('Username or E-mail', 'iii-dictionary') ?></label>
                                <input type="text" name="user_login" id="user_login" class="form-control" value="" style="height: 39px">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 css-pad-right0-desktop css-width-50-tablet">
                            <div class="form-group css-btn-new-password">
