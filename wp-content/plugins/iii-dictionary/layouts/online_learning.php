...
update_user_subscription();
$is_sub_self_english = $_SESSION['subscription']['SELF_STUDY'];
$is_sub_self_math = $_SESSION['subscription']['SELF_STUDY_MATH'];
...
if (isset($_POST['join'])) {
    ...
    if (MWDB::join_group($gname, $gpass, $current_user_id)) {
        if(is_math_panel()){
            wp_redirect(locale_home_url() . '/?r=online-learning&backhometeacher-math');
        }else{
            wp_redirect(locale_home_url() . '/?r=online-learning&backhometeacher-english');
        }
        exit;
    }
    session_destroy();
...
<script>
    var check_math = <?php if($is_math_panel){echo 1;}else{echo 0;}?>;
    var sub_english = <?php if($is_sub_self_english || $is_login){echo 1;}else{echo 0;}?>;
    var sub_math = <?php if($is_sub_self_math || $is_login){echo 1;}else{echo 0;}?>;
    
    if(check_math =='0' ){
        if(sub_english ==1) {
            jQuery('#span-title').html("<span class='icon-question-orange' id='icon-info-sub'></span><span class='css-text-sub-new'>Self-study: <b>Subscribed</b></span>");
        }
    }else{
        if(sub_math ==1) {
            jQuery('#span-title').html("<span class='icon-question-orange' id='icon-info-sub-math'></span><span class='css-text-sub-new'>Self-study: <b>Subscribed</b></span>");
        }
    }
</script>
<div id="div-all-select" class="margin-mb">
    <div id="div-select">
        <section class="select1"> 
            <select class="cs-select set-selected cs-skin-border">
                <?php if ($is_math_panel) { ?>
                    ...
                    <option value="sattest">SAT Preparation and Simulation Test</option>
                    <option value="tutoring_plan">Tutoring Plan</option> 
                    <option value="homeworkagm">Assignment from Teacher</option>
                <?php } else { ?>
...
<div  style="margin-top: 30px" class="col-sm-12 p-left5-percent css-padd-lr7 css-div-tab">
            ...
            <form method="post" action="<?php echo locale_home_url() ?>/?r=online-learning<?php echo $gid ? '&amp;gid=' . $gid : '' ?><?php echo $gid ? '&amp;price=' . $gi : '' ?>">
                <div class="box-header box-header-custom">
                    ...
                    <?php } else if(isset($_GET['gid'])){ ?>
                            <?php if(is_math_panel()) {  ?>
                                ...
                                <?php } else if(strpos($url, 'sat2e') !== false){ ?>
                                    ...
                                    <?php } else if(strpos($url, '&homeworkagm-math') !== false){ ?>
                                    <a href="<?php echo home_url() ?>/?r=online-learning&backhometeacher-math" class="link-back css-back" style="height: 39px;"><span class="span-icon-left css-icon-back"></span><span class="txt-back">BACK</span></a>
                                <?php } else { ?>
                            ...
                            <?php } else { ?>
                                ...
                                <?php } else if(strpos($url, '&homeworkagm-english') !== false){ ?>
                                    <a href="<?php echo locale_home_url() ?>/?r=online-learning&backhometeacher-english" class="link-back css-back" style="height: 39px;"><span class="span-icon-left css-icon-back"></span><span class="txt-back">BACK</span></a>
                                <?php }else{?>
                                    <a href="<?php echo locale_home_url() ?>/?r=online-learning<?php echo $id?>" class="link-back css-back" style="height: 39px;"><span class="span-icon-left css-icon-back"></span><span class="txt-back">BACK</span></a>
                                <?php } ?>
                            <?php } ?>
                    ...
                    <div class="col-xs-12" style="padding-left: 0px !important;padding-top: 10px">
                        <p  class="col-xs-12" style="color: #fcd971;float: left;padding-right: 5px;padding-left: 15px !important;"><span  style="color: #ffcc62;font-size: 18px;" class=""><?php echo $group->name ?></span></p>
                        <p class="col-xs-12 padd-left-15" ><?php _e('By:', 'iii-dictionary') ?> <span><?php echo $group->display_name ?></span></p>                        
                    </div>
                </div>
                <div class="homeworkcritical-online can-scroll" style="height: 500px">
                    <div style="width: 100%">
                        <table class="table table-striped table-condensed ik-table1 text-center vertical-middle scroll-fix-head table-sub-sat-pre-sim-test" id="homeworkcritical">
                            <thead class="homeworkcritical">
                                <tr>
                                    ...
                                    ?>      
                                    <?php if($check_css == 1) { ?>
                                        <th class="text-color-custom-1 padd-left-15"><?php _e('Worksheet Name', 'iii-dictionary') ?></th>
                                    <?php }else {?>
                                        <th class="text-color-custom-1 padd-left-15"><?php _e('Worksheet Name', 'iii-dictionary') ?></th>
                                    <?php }?>
                                    <th class="text-color-custom-1"><?php _e('Due date', 'iii-dictionary') ?></th>
                                    <th class="text-color-custom-1"><?php _e('Mode', 'iii-dictionary') ?></th>
                                    <th class="text-color-custom-1" ><?php _e('Answer', 'iii-dictionary') ?></th>
                                    <th class="text-color-custom-1" ><?php _e('', 'iii-dictionary') ?></th>
                                </tr>
                            </thead>
                            
                            <tbody style="max-height: 440px">
                                <?php
                                $total_score = 0;
                                $total_ws = 0;
//                                var_dump($homeworks->items);die;
...
//                                        var_dump($hw);die;
                                        ?>
                                        <tr>
                                            <td class="padd-left-15" style="text-align: left"><?php if($hw->homework_name){echo $hw->homework_name;}else{echo $hw->sheet_name;} ?></td>
                                            ...
                                            ?>
                                            <td style="color: #0065bb !important"><?php if($hw->for_practice ==1){echo "Practice";}else{echo "Test";}?></td>
                                            <td style="color:#256CAA;">
                                                <?php
                                                    ...
                                                    // Link Preview Worksheet  
                                                    $practice_url_preview = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;ba-preview-modal&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&amp;preview=1&ismode='.$hw->for_practice;
                                                    $homework_url_preview = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;ba-preview-modal&amp;mode=homework&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&amp;preview=1&ismode='.$hw->for_practice;
                                                    if(strpos($url, '&homeworkagm-math') !== false){
                                                        $practice_url_preview = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;homeworkagm-math&amp;ba-preview-modal&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&amp;preview=1&ismode='.$hw->for_practice;
                                                        $homework_url_preview = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;homeworkagm-math&amp;ba-preview-modal&amp;mode=homework&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&amp;preview=1&ismode='.$hw->for_practice;
                                                    }else if(strpos($url, '&homeworkagm-english') !== false){
                                                        $practice_url_preview = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;homeworkagm-english&amp;ba-preview-modal&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&amp;preview=1&ismode='.$hw->for_practice;
                                                        $homework_url_preview = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;homeworkagm-english&amp;ba-preview-modal&amp;mode=homework&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&amp;preview=1&ismode='.$hw->for_practice;
                                                    }
                                                ?>
                                                <?php if(is_math_panel()) { 
                                                    if(isset($_GET["back-ikmath"])){ // MENU ikmath Course all ws is mode: practice
                                                    ?>
                                                        <span style="color: #cd003d">N/A</span>
                                                    <?php
                                                    }else if($hw->for_practice ==1){ ?>
                                                        <span style="color: #cd003d">N/A</span>
                                                    <?php
                                                    }else if($hw->score =='100') { 
                                                        $total_ws++;
                                                        $total_score += (int)$hw->score;
                                                        ?>
                                                        <button type="button" data-practice-url-preview="<?php echo $practice_url_preview ?>" data-practice-url="<?php echo $practice_url ?>" data-mode="<?php echo $hw->for_practice;?>" class="btn btn-default btn-tiny grey btn-a-link view-result-none-writing" style="color: #657d00" data-status="<?php  echo $txt?>" id_g="<?php  echo $g?>" id="<?php  echo  $hw->hid  ?>"> <?php echo $hw->score."%" ?></button>
                                                    <?php }else if($hw->score > 0){ 
                                                        $total_ws++;
                                                        $total_score += (int)$hw->score;
                                                        ?>
                                                        <button type="button" data-practice-url-preview="<?php echo $practice_url_preview ?>" data-practice-url="<?php echo $practice_url ?>" data-mode="<?php echo $hw->for_practice;?>" class="btn btn-default btn-tiny grey btn-a-link view-result-none-writing" style="color: #cd003d" data-status="<?php  echo $txt?>" id_g="<?php  echo $g?>" id="<?php  echo  $hw->hid  ?>"> <?php echo $hw->score."%" ?></button>
                                                    <?php } else {
                                                        if(json_decode($hw->questions)->answer =="no answer" && $hw->assignment_id==13){ ?>
                                                            <span style="color: #cd003d">N/A</span>
                                                        <?php }else{
                                                            $total_ws++; ?>
                                                            <button type="button" data-practice-url-preview="<?php echo $practice_url_preview ?>" data-practice-url="<?php echo $practice_url ?>" data-mode="<?php echo $hw->for_practice;?>" class="btn btn-default btn-tiny grey btn-a-link view-result-none-writing" style="color: #cd003d" data-status="<?php  echo $txt?>" id_g="<?php  echo $g?>" id="<?php  echo  $hw->hid  ?>"> <?php echo "0%" ?></button>
                                                        <?php }
                                                        }
                                                 } else { 
                                                    if($hw->for_practice ==1){ ?>
                                                        <span style="color: #cd003d">N/A</span>
                                                    <?php
                                                    }else if($hw->score =='100') {
                                                        $total_ws++;
                                            ...
                                            <td>
                                                <?php
                                                    ...
                                                    if(strpos($url, '&issat-math') !== false){  // Back "ikMath Courses"
                                                        $practice_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;issat-math=1&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice;
                                                        $homework_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;issat-math=1&amp;mode=homework&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice;
                                                    }else if (strpos($url, '&sat') !== false){
                                                        $sat = $_GET["sat"];
                                                        $practice_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;sat='.$sat.'&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice;
                                                        $homework_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;sat='.$sat.'&amp;mode=homework&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice;
                                                    }else if(strpos($url, '&ikcourse') !== false){  // Back "SAT Preparation and Simulation Test"
                                                        $last_url = substr($url, -8);
                                                        $array = split('&', $last_url);
                                                        $practice_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;hid=&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice.'&page-back='.$get_id_page;
                                                        $homework_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;mode=homework&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice.'&page-back='.$get_id_page;
                                                    } else if(strpos($url, '&homeworkagm-math') !== false){ // Back "SAT Preparation and Simulation Test"
                                                        $practice_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;homeworkagm-math&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice;
                                                        $homework_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;homeworkagm-math&amp;mode=homework&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice;
                                                    }else if(strpos($url, '&homeworkagm-english') !== false){ // Back "SAT Preparation and Simulation Test"
                                                        $practice_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;homeworkagm-english&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice;
                                                        $homework_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;homeworkagm-english&amp;mode=homework&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice;
                                                    }else if(!empty($_GET["back-ikmath"])){
                                                        $practice_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice.'&amp;back-ikmath='.$_GET["back-ikmath"];
                                                        $homework_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;mode=homework&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice.'&amp;back-ikmath='.$_GET["back-ikmath"];
                                                    }else {
                                                        $practice_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice;
                                                        $homework_url = MWHtml::get_practice_page_url($hw->assignment_id) . '&amp;mode=homework&amp;hid=' . $hw->hid.'&amp;back&amp;sid=' . $hw->sheet_id.'&amp;sat='.$s.'&amp;gid='.$g.'&ismode='.$hw->for_practice;
                                                    }
                                                    if($is_sat_class_subscribed)
                                                        $annoying = 0;
                                                    else
                                ...
                                <?php
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="5" style="width: 1%;display: table-cell;"><?php _e('No homework assigned to this Group yet', 'iii-dictionary') ?></td>
                                    </tr>
                                    <?php for ($i = 0; $i < 13; $i++) { ?>
                                        <tr ><td style="height : 35px; width: 1%" colspan="7" ></td></tr>
                                    <?php } ?>
                            ...
                            <tfoot style="background: #838383;text-align: right">
                                <?php if($total_ws){ ?>
                                    <tr><td colspan="6" class="td-average-score"><span style="color: #fff">Total Score: </span><span class="txt-average"><?php echo round($total_score/$total_ws,2)."%"; ?></span></td></tr>
                                <?php }else{?>
                                    <tr><td colspan="6" class="td-average-score"><span style="color: #fff">Total Score: </span><span class="txt-average"><?php echo "0%"; ?></span></td></tr>
                                <?php }?>
                            </tfoot>
                        </table>
                    </div>
...
//                var_dump($get_title_group);die;
            ...
            <form method="post" action="<?php echo locale_home_url() ?>/?r=online-learning<?php echo $gid ? '&amp;gid=' . $gid : '' ?><?php echo $gid ? '&amp;price=' . $gi : '' ?>">
                <div class="box-header box-header-custom" >
                    ...
                    <?php } ?>
                    <div class="col-xs-12" style="padding-left: 0px !important;padding-top: 10px">
                        <p  class="col-xs-12" style="color: #fcd971;float: left;padding-right: 5px;padding-left: 15px !important;"><span  style="color: #ffcc62;font-size: 18px;" class=""><?php echo $get_title_group[0]->name ?></span></p>
                        <p class="col-xs-12 padd-left-15" ><?php _e('By:', 'iii-dictionary') ?> <span><?php echo $get_title_group[0]->display_name ?></span></p>                        
                    </div>
                </div>
                <div class="homeworkcritical-online can-scroll" style="height: 500px">
                    <div style="width: 100%">
                        <table class="table table-striped table-condensed ik-table1 text-center vertical-middle scroll-fix-head" id="homeworkcritical">
                            <thead class="homeworkcritical">
                                <tr>
                                    <th class="text-color-custom-1 width-th-sub-cri1"><?php _e('List of Worksheet', 'iii-dictionary') ?></th>
                                    <th class="text-color-custom-1  width-th-sub-cri2"><?php _e('Due date', 'iii-dictionary') ?></th>
                                    <th class="text-color-custom-1  width-th-sub-cri2"><?php _e('Mode', 'iii-dictionary') ?></th>
                                    <th class="text-color-custom-1  width-th-sub-cri3" ><?php _e('Answer', 'iii-dictionary') ?></th>
                                    <th class="text-color-custom-1  width-th-sub-cri4"><?php _e('', 'iii-dictionary') ?></th>
                                </tr>
                            </thead>
                            <tfoot>
                            ...
                            <tbody style="max-height: 468px;"> 
                                ...
                                if (!empty($worksheet)) :
                                    foreach($worksheet as $value):
                                        ?>
                                        <tr>
                                            <td style="width: 40%;text-align: left !important;padding-left: 15px"><?php if(empty($value->name)) echo $value->sheet_name; else echo $value->name;?></td>
                                            <td style="width: 20%"><?php echo $value->deadline == '0000-00-00' ? 'No deadline' : ik_date_format($value->deadline) ?></td>
                                            <td><span style="color: #006fbd">Practice</span></td>
                                            <td><span style="color: #cd003d">N/A</span></td>
                                            <td style="width: 16%;padding-right: 2%;">
                                                <?php 
                                                if (empty($get_stg->step_of_user) && $item->price != 0 || !is_user_logged_in()) { ?>
                                                <a href="#" data-name="<?php echo $item->name ?>" data-free=<?php echo ( $item->price == 0 ) ? '1' : '0' ?> data-jcid="<?php echo $item->id ?>" class="bold-font btn btn-default btn-block btn-tiny grey btn-a-link join-class-lang-btn"><?php _e('START', 'iii-dictionary') ?></a> <!--JOIN-->
                                                    <?php
                                                ...
                                                <?php }else {  
                                                    ...
                                                    if(!empty($_GET["lvid"])) {
                                                        $practice_url = MWHtml::get_practice_page_url($get_stg->step['assg']) . '&amp;ismode=1&amp;back&amp;hid=' . $value->id.'&amp;sid='.$value->sheet_id.'&amp;pr=' . $item->price.'&amp;lvid=' .$_GET["lvid"];
                                                        $homework_url = MWHtml::get_practice_page_url($get_stg->step['assg']) . '&amp;ismode=0&amp;back&amp;hid=' . $value->id.'&amp;sid='.$value->sheet_id.'&amp;pr=' . $item->price.'&amp;lvid=' .$_GET["lvid"];
                                                    }else{
                                                        $practice_url = MWHtml::get_practice_page_url($get_stg->step['assg']) . '&amp;ismode=1&amp;back&amp;hid=' . $value->id.'&amp;sid='.$value->sheet_id.'&amp;pr=' . $item->price;
                                                        $homework_url = MWHtml::get_practice_page_url($get_stg->step['assg']) . '&amp;ismode=0&amp;back&hid=' . $value->id.'&amp;sid='.$value->sheet_id.'&amp;pr=' . $item->price;
                                                    }
            ...
            <form method="post" action="<?php echo locale_home_url() ?>/?r=online-learning<?php echo $gid ? '&amp;gid=' . $gid : '' ?><?php echo $gid ? '&amp;price=' . $gi : '' ?>">
                <div class="box-header box-header-custom" style="height: 48px;">
                    ...
                    <div class="col-xs-12" style="padding-left: 0px !important;padding-top: 10px;width: 75%">
                        <p  class="col-xs-12" style="color: #fcd971;float: left;padding-right: 5px;padding-left: 15px !important;"> 
                ...
                <div class="homeworkcritical-online can-scroll" style="height: 500px">
                    <div style="width: 100%">
                        <table class="table table-striped table-condensed ik-table1 text-center vertical-middle scroll-fix-head" id="homeworkcritical">
                            <thead class="homeworkcritical">
                                <tr>
                                    <th class="text-color-custom-1" style="width: 33%; text-align: left;padding-left: 15px;"><?php _e('List of Worksheet', 'iii-dictionary') ?></th>
                            ...
                            <tbody>
                                ...
                                if (!empty($obj)) :
                                    foreach($obj as $value):
                                        ?>
                                        <tr>
                                            <td style="width: 52%;text-align: left !important;padding-left: 15px"><?php echo $value->sheet_name?></td>
                                            <td style="width: 20%"><?php echo $value->deadline == '0000-00-00' ? 'No deadline' : ik_date_format($value->deadline) ?></td>
...
<?php } ?>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            if (jQuery('.cs-select option:selected').val() == 'homeworkfrom') {
...
if (!$is_math_panel) {
    ...
    ?>
                <div >
                    <h3 style="margin: 0 0 10px 0;"><?php _e('SAT Preparation', 'iii-dictionary'); ?></h3>
            <?php MWHtml::load_homework_math_sat(); ?>
                </div>
                <div style="padding-top: 35px">
                    <h3 style="margin: 0 0 10px 0;"><?php _e('SAT 2 Preparation', 'iii-dictionary'); ?></h3>
        ...
        <div class="col-xs-6 pad-right">
            <div class="col-xs-12 pad-right">
                <form method="post" action="<?php echo locale_home_url() ?>/?r=online-learning">
                    <h3 style="margin: 0 0 10px 0;"><?php _e('Join the Class', 'iii-dictionary'); ?></h3>
                    <p style="margin: 0 0 10px 0;" class="color-8d8d8d"><?php _e('In order to join the class, you must obtain the Class Name and the Password from your teacher', 'iii-dictionary'); ?></p>
                    <div class="row" style="margin-bottom:10px">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="gname" class="p-custom"><?php _e('Class Name ', 'iii-dictionary') ?></label>
                                <input type="text" class="form-control" id="gname" name="gname" value="<?php echo $gname ?>">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="gpass" class="p-custom"><?php _e('Class password', 'iii-dictionary') ?></label>
                    ...
                    <div id="join-group-dialog" class="modal fade modal-red-brown" aria-hidden="true">
                        <div class="modal-dialog modal-join-group">
                            <div class="modal-content">
                                <div class="modal-header custom-header">
                                    <span style="right: 3%;padding-top: 2%;" href="#" data-dismiss="modal" aria-hidden="true" class="close close-dialog"></span>
                                    <h3><?php _e('Joining the class', 'iii-dictionary') ?></h3>
                                </div>
                                <div class="modal-body body-custom">
                                    <h4 class="text-join-group" ><?php _e('Are you sure about joining to this class?', 'iii-dictionary') ?></h4>
                                    <p class="text-p-join-group"><?php _e('Are you sure you are joining to this class? When this class name is provided by your teacher, your name will show up in his/her class member list and it will cost the student, if subscription is required. Otherwise, it is free.', 'iii-dictionary') ?></p>
                                    <hr>
                                    <h4 class="text-join-group"><?php _e('Do you want to join class chat (chat board for this class)?', 'iii-dictionary') ?></h4>
                                    <div class="radio">															
                ...
                <table id="members-list-modal" class="table table-striped table-condensed ik-table1 ">
                    <thead>
                        <tr style="background: #aaaaaa;">
                            <th style="padding-left: 15px" class="text-color-custom-1"><?php _e('Account Name', 'iii-dictionary') ?></th>
...
<div id="modal-view-result-homework" class="modal fade modal-red-brown">
    <div class="modal-dialog modal-custom-first">
        <div class="modal-content boder-black">
            <div class="modal-header custom-header" >
                <span style="right: 3%;margin-top: -3px !important;" class="close close-dialog close-modal-view-homework"></span>
            ...
            <div class="modal-footer footer-custom" style="padding: 1% 5% 40px 5%;">
                <span class="text-food-view-rs">Restart the Worksheet. This will clear the current score.</span>
...
<div id="modal-view-result-writing" class="modal fade modal-red-brown">
    <div class="modal-dialog modal-custom-first">
        <div class="modal-content boder-black">
            ...
            <div class="modal-footer footer-custom" style="padding-left: 15px;padding-top: 0px;">
...
<div id="modal-enter-evaluation-english" class="modal fade modal-red-brown">
    <div class="modal-dialog modal-custom-first">
        <div class="modal-content boder-black">
            ...
            <div style="background: #fff;color: #000;padding-top: 3%;padding-left: 15px;padding-right: 5%">
            ...
            <div class="modal-footer footer-custom" style="padding-left: 15px">
