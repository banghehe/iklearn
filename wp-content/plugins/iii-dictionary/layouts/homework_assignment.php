...
if (empty($route[1])) {
    $active_tab = 'english';
    $_page_title = __('Assignment Manager', 'iii-dictionary');
} else {
    $active_tab = $route[1];
    $_page_title = __('Assignment Manager', 'iii-dictionary');
}
...
if (isset($task['register'])) {
    ...
    $_SESSION['hw-for-practice']=$_REAL_POST['hw-for-practice'];
    $_SESSION['is-retryable']=$_REAL_POST['is-retryable'];
    $_SESSION['teacherlastpage']=$data['teacherlastpage'];
    ...
    switch ($active_tab) :
        ...
        case 'english':
            ...
            <?php if ($layout != 'create') : ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="title-border"><?php _e('English Assignment', 'iii-dictionary') ?> <small><?php _e('(Select one to assign)', 'iii-dictionary') ?></small></h2>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="" style="max-height: 600px;overflow: auto;">
                                        <table class="table table-striped table-condensed ik-table1 vertical-middle text-center scroll-fix-head" id="list-sheets">
                                            <thead>
                                                <tr>
                                                    <th class="hidden-xs" style="width: 20%;padding-left: 65px;"><?php _e('Lesson', 'iii-dictionary') ?></th>
                                                    <th class="hidden-xs" style="min-width: 80px;width: 20%;padding-left: 87px;">
                                                    ...
                                                    <th class="hidden-sm" style="text-align: right;padding-right: 3%"><?php _e('Dictionary', 'iii-dictionary') ?></th>
                                                    <th style="padding-right: 95px">
        ...
        case 'mathematics':
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="title-border"><?php _e('Math Assignment', 'iii-dictionary') ?> <small><?php _e('(Select one to assign)', 'iii-dictionary') ?></small></h2>
                </div>
                <div class="col-sm-5 col-md-4 col-sm-offset-7 col-md-offset-8">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-xs-6">
                                                                                <div class="radio radio-style1">
                                                                                    <input id="hw-for-test" type="radio" name="hw-for-practice" value="0" <?php if(isset($_SESSION['hw-for-practice'])){echo $_SESSION['hw-for-practice']==0? 'checked':'';}else{ echo 'checked';} ?>>
                                                                                    <label for="hw-for-test"><?php _e('Test', 'iii-dictionary') ?></label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-xs-6">
                                                                                <div class="radio radio-style1">
                                                                                    <input id="hw-for-practice" type="radio" name="hw-for-practice" value="1" <?php echo $_SESSION['hw-for-practice']==1? 'checked':'' ?>>
                                                                            ...
                                                                            <div class="row col-sm-12">
                                                                                <div class="col-xs-6">
                                                                                    <div style="float:left">
                                                                                        <input id="rdo-no" class="checkboxpage"  type="checkbox" name="checkboxpage" value="1" <?php echo $_SESSION['teacherlastpage']==1? 'checked':'' ?> >
                                                                                    </div>
                                                                                    <div >
