...
//    include 'home_sat_new.php';
    ...
    <div id="content" class="english-content">
        <div class="txt-critical-english">Critical English Lessons</div>
        ...
        <div  id="div_hw3">
            <div id="homeworkcourse" class="css-mg-mb" style="overflow: hidden;">
                <div class="homeworkcritical-online can-scroll" style="height:415px;" >
                    <div class="width-table-display">
                    <table class="table table-striped table-condensed ik-table1 table-critical-lesson table-scroll" id="homeworkcritical" >
    ...
    //                                    var_dump($get_stg->step);
                                        ...
                                        <tr>
                                            ...
                                            <td style=""><div><a href="#" class="bold-font btn btn-default btn-block btn-tiny grey btn-a-link css-text-left <?php
                                                    if (is_null($exist)) {
                                                        echo 'not-join';
                                                    } else {
                                                        echo '';
    ...
    //                                                        var_dump($get_stg->step['id']);
                                                    if (empty($get_stg->step_of_user) && $item->price != 0 || !is_user_logged_in()) { ?>
                                                        <a href="#" data-name="<?php echo $item->name ?>" data-free="<?php echo ( $item->price == 0 ) ? '1' : '0' ?>" data-price="<?php echo $item->price;?>" data-jcid="<?php echo $item->id ?>" class="bold-font btn btn-default css-text-left btn-block btn-tiny css-color-006fbd btn-a-link join-class-lang-btn"><?php _e('JOIN', 'iii-dictionary') ?></a>
                                                        <?php } else { ?>
                                                        <a href="<?php echo locale_home_url() ?>?r=online-learning&english&lvid=<?php echo $item->id?>" class="bold-font btn btn-default btn-block btn-tiny css-color-006fbd css-text-left btn-a-link prevent-detail-btn-<?php echo $is_math ? 'math' : 'english' ?> "><?php _e('START', 'iii-dictionary') ?></a>
                                                    <?php } ?>
                                                </td>
                                            <td style=""><div ><?php
