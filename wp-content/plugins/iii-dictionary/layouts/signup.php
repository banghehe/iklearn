...
<script>
	...
	<form method="post" action="<?php echo locale_home_url() ?>/?r=signup" name="registerform">
		<div class="row">
			<div class="col-sm-9 css-pad-left0-desktop">
				<div class="form-group margin-bottom-0-mb">
			...
			<div class="col-sm-3">
				<div class="form-group margin-bottom-0-mb lb-check-mail">														
			...
			<div class="col-sm-6 col-md-6 css-pad-left0-desktop">
				<div class="form-group">
			...
			<div class="col-sm-6 col-md-6 css-pad-right0-desktop">
				<div class="form-group">
			...
			<div class="col-sm-6 col-md-6 css-pad-left0-desktop">
				<div class="form-group">
					...
					<div class="row tiny-gutter">
						<div class="col-xs-4 css-pad-left0-tablet css-pad-left0-mb">
