<?php
	// for chat module
	//wp_enqueue_script('nodejs-socket', 'http://107.180.78.210:8000/socket.io/socket.io.js', array(), '1.0.0', true );
	...
	//eue_script('chat-main-js', plugins_url('iii-dictionary/chat/js/chatMain.js'), array(), '1.0.0', true );

	//////////////////////////////////////////////////
	$sheet_id = empty($_GET['sid']) ? 0 : $_GET['sid'];
//        $curr_mode = if(empty($_GET['mode'])){ echo 'practice' }else{echo '$_GET['mode']'};
        if(empty($_GET['mode'])) {
            $curr_mode = 'practice';
        }else{
            $curr_mode = $_GET['mode'];
		...
		<div class="row">
			<form id="main-form" method="post" action="<?php echo locale_home_url() . '/?r=math-homework&amp;mode=' . $curr_mode; echo !empty($_GET['hid']) ? '&amp;hid=' . $_GET['hid'] : ''; echo !empty($_GET['ref']) ? '&amp;ref=' . $_GET['ref'] : '' ?>">
				<div class="col-sm-2 homework-nav">
					<?php
// var_dump($homework->assignment_id);die;
				...
				<?php if( is_user_logged_in() ) : ?>
					...
					<div class="section-register <?php echo (!$_is) ? 'display-block' : '' ?>">
						<div class="col-md-12 block-body">
							...
							<label class="block-chat-price" ><?php printf(__('Price $%d / 15 minutes', 'iii-dictionary'),  mw_get_option('math-chat-price')) ?></label>
						</div>
...
<?php endif ?>
<div id="menu-notepad" class="menu-notepad">
	<div id="close-menu" class="close-menu"><img src="'.site_url() . '/wp-content/themes/ik-learn/library/images/delete_white.png"></div>
	<div class="block-menu"><img src="'.site_url() . '/wp-content/themes/ik-learn/library/images/Pencil.png" class="icon-block">
	 <div class="custom-radios radio-pencil">
	        <div>
	            <input id="pencil-1" name="pencil" value="1" checked="" type="radio">
	            <label for="pencil-1">
	                <span><hr></span>
	            </label>
	        </div>
	        ...
	        <div>
	            <input id="pencil-2" name="pencil" value="2" type="radio">
	            <label for="pencil-2">
	                <span><hr></span>
	            </label>
	        </div>
	        ...
	        <div>
	            <input id="pencil-3" name="pencil" value="3" type="radio">
	            <label for="pencil-3">
	                <span><hr></span>
	            </label>
	        </div>
	        ...
	        <div>
	            <input id="pencil-4" name="pencil" value="4" type="radio">
	            <label for="pencil-4">
	                <span><hr></span>
	            </label>
	        </div>
	...
	<hr>
	<div class="block-menu"><img src="'.site_url() . '/wp-content/themes/ik-learn/library/images/Color_Selection.png" class="icon-block">   
	    <div class="custom-radios">
	        <div>
	            <input id="color-black" name="color" value="#000000" checked="" type="radio">
	        ...
	        <div>
	            <input id="color-blue" name="color" value="#0000FF" type="radio">
	        ...
	        <div>
	            <input id="color-red" name="color" value="#FF0000" type="radio">
	            <label for="color-red">
	                <span></span>
	            </label>
	        </div>
	        ...
	        <div>
	            <input id="color-green" name="color" value="#008000" type="radio">
	        ...
	        <div>
	            <input id="color-white" name="color" value="#FFFFFF" type="radio">
	...
	<hr>
	<div class="block-menu last"><img id="pencilrubber" data-title="Eraser" src="'.site_url() . '/wp-content/themes/ik-learn/library/images/Eraser.png" class="icon-block">   
	 <div class="custom-radios radio-eraser">
	        <div>
	            <input id="eraser-200" name="eraser" value="100" type="radio">
	            <label for="eraser-200">
	                <span></span>
	            </label>
	        </div>
	          
	        <div>
	            <input id="eraser-100" name="eraser" value="80" type="radio">
	            <label for="eraser-100">
	                <span></span>
	            </label>
	        </div>
	          
	        <div>
	            <input id="eraser-50" name="eraser" value="50" checked="" type="radio">
	            <label for="eraser-50">
	                <span></span>
	            </label>
	        </div>
	...
	<div id="clear-state" class="clear-state"><img src="'.site_url() . '/wp-content/themes/ik-learn/library/images/Clear.png"></div>   
</div>
<div id="cursors"></div>
<canvas id="math" class="canvas-math hidden">Your browser needs to support canvas for this to work!</canvas>
