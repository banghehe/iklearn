...
$tab_options = array(
    'items' => array(
        'english' => array('url' => home_url() . '/?r=create-group/english', 'text' => 'English'),
        'mathematics' => array('url' => home_url() . '/?r=create-group/mathematics', 'text' => 'Mathematics')
    ),
    'active' => $active_tab
);
...
$tab_options['items'] = array(
    'english' => array('url' => home_url() . '/?r=create-group/english', 'text' => 'English'),
    'mathematics' => array('url' => home_url() . '/?r=create-group/mathematics', 'text' => 'Math')
);
...
if (isset($task['register'])) {
    ...
    if (!$checktool) {
        ...
        wp_redirect(locale_home_url() . '/?r=create-group/' . $active_tab);
        exit;
    }
}
    ...
    case 'english':
        ...
        if (isset($task['create']) || isset($task['update'])) {
            ...
            if (MWDB::store_sheet($data)) {
                wp_redirect(locale_home_url() . '/?r=create-group/english');
                exit;
            } else {
                if ($_REAL_POST['sheet-id']) {
                    wp_redirect(locale_home_url() . '/?r=create-group/english&layout=create&cid=' . $_REAL_POST['sheet-id']);
                    exit;
                }
            }
        }
...
if(isset($_GET['gid']) || isset($_GET['grid'])){
    if(isset($_GET['gid'])){
        echo locale_home_url() . '/?r=create-group&gid='.$_GET['gid'];
    }else{
        echo locale_home_url() . '/?r=create-group&grid='.$_GET['grid'];
    }
}else{
    echo locale_home_url() . '/?r=create-group/' . $active_tab;
}
    ...
    switch ($active_tab) :
        ...
        case 'english':
            ...
            <?php if ($layout != 'create') : ?>
                ...
                <div class="row">
                    <div class="col-sm-12 padd-left-right-0-tablet"> 
                        <h2 class="title-border padd-left-43-tablet title-list-class"><?php _e('List of "Class" Groups', 'iii-dictionary') ?> </h2> 
                    </div>
...
<!--                                <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                              <select name="filter[grade]" class="select-box-it select-sapphire form-control" id="filter-subject" >
                                                    ...
                                                    <?php MWHtml::select_grades('ENGLISH', array('class' => 'select-sapphire form-control')) ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <table class="table table-striped table-condensed ik-table1 text-center">
                                                ...
                                                <tbody>
                                                    <?php if (empty($list_home)) : ?>
                                                        <tr><td colspan="8"><?php _e('You haven\'t created any group yet.', 'iii-dictionary') ?></td></tr>
                                                        <?php
                                                    else :
                        ...
                        <!--When lick button "List of Assignments" isset($_GET[grid]) -->  
                        <!-- grid la mot so lop dac biet special_group==2 gom cac Grade 1,2,..,12,SAT,Student Group, School, School 2.., School 5--> 
                            <?php } else if (isset($_GET["grid"])){ ?>
                                <?php $list_home = MWDB::get_sheets_by_grade($_GET["grid"]) ?>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="" style="max-height: 600px;overflow: auto;">
                                            <table class="table table-striped table-condensed ik-table1 text-center">
...
//                                                        var_dump($groups->special_group);die;
                                                        foreach ($groups->items as $item) :
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="hidden-xs css-padding-5">
                                                                    <?php if($item->special_group !='0' && $item->special_group !='1'):?>
                                                                            <button type="button" class="btn btn-default btn-block btn-tiny grey btn-list-assignment" data-id="<?php echo $item->id ?>"><a href="<?php home_url() ?>?r=create-group&grid=<?php echo $item->special_group ?>" style="color: #000;text-decoration: none;">List of Assignments</a></button>
                                                                    <?php else:?>
            ...
            <?php else : ?>
                ...
                <div class="row homework">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="<?php echo locale_home_url() ?>/?r=create-group/english" class="btn btn-default btn-block grey"><span class="icon-goback"></span><?php _e('Go back', 'iii-dictionary') ?></a>
                        </div>
                    </div>
                </div>
        ...
        case 'mathematics':
            ...
            <div class="row">
                <div class="col-sm-12 padd-left-right-0-tablet">
                    <h2 class="title-border padd-left-43-tablet"><?php _e('List of "Class" Groups', 'iii-dictionary') ?> </h2>
                </div>
                <div class="col-sm-4 col-sm-offset-8">
                    <div class="form-group">
                        <a href="<?php echo locale_home_url() ?>/?r=create-group&amp;layout=create" class="btn btn-default orange form-control">
                ...
                <div class="col-sm-5 col-md-4 col-sm-offset-7 col-md-offset-8">
                    <div class="form-group hidden">
                        <a href="<?php echo home_url() ?>/?r=create-group/mathematics&amp;layout=create" class="btn btn-default orange form-control"><span class="icon-plus"></span><?php _e('Create my own', 'iii-dictionary') ?></a>
                    </div>
                </div>
                <div class="col-sm-12 css-padding-left-0 css-padding-right-0">
                    <div class="box box-sapphire">
                        <div class="row box-header">
                            <div class="col-sm-12">
                                <div class="row search-tools">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="">
                                    <table class="table table-striped table-condensed ik-table1 vertical-middle text-center scroll-fix-head1">
                                        <thead>
                                            <tr>
                                                <th class="hidden-xs" style="width: 16% !important;"><?php _e('Level Category', 'iii-dictionary') ?></th>
                                                <th class="hidden-xs" style="width: 14% !important;">
                                                ...
                                                <th class="hidden-xs" style="width: 23% !important;">
                                                ...
                                                <th class="hidden-xs" style="width: 25% !important;padding-right: 6%;">
                                        ...
                                        <tbody><?php if (empty($avail_sheets)) : ?>
                                                ...
                                                <?php
                                                    ...
                                                    ?><tr<?php echo $sheet->active ? '' : ' class="hidden"' ?> data-id="<?php echo $sheet->id ?>" 
                                                                                                             ...
                                                                                                             ?>><?php ?><td class="hidden-xs"><?php echo $sheet->level_category_name ?></td><?php ?><td><?php echo $sheet->level_name ?></td><?php ?><td class="hidden-xs"><?php echo $sheet->sublevel_name ?></td><?php ?><td class="hidden-xs"><?php echo $sheet->type ?></td><?php ?><td class="hidden-xs"><?php echo $sheet->sheet_name ?></td><?php ?><td><?php if (!$cannot_use_subscribed_worksheet || $is_admin) : ?>
                                                    ...
                                                    <div class="col-sm-5 col-md-4 col-sm-offset-7 col-md-offset-8 hidden">
                                                        ...
                                                        <a href="<?php echo home_url() ?>/?r=create-group/mathematics&amp;layout=create" class="btn btn-default btn-block orange form-control"><span class="icon-plus"></span><?php _e('Create my own', 'iii-dictionary') ?></a>
                                                    </div>
                                                    </div>
