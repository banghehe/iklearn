<?php
	...
	// $action_url_send = locale_home_url() . '/?r=online-learning';
...
<script>
jQuery('#private-messages .article-header').css('background', '#ffffff');
    jQuery('#private-messages .entry-content').css('background', '#ffffff');
    if ((window.matchMedia('screen and (min-width: 1200px)').matches)) {
        jQuery('#main').removeClass('container');
        jQuery('#private-messages .article-header .row').attr('style', 'width:1050px; margin:auto !important');
        jQuery('#private-messages .entry-content .row:first').attr('style', 'width:1050px; margin:auto !important');
    }
    jQuery('#private-messages #page-tabs-container').css('background', '#ffffff');
    jQuery('#private-messages .entry-content').css('color', 'black');
...
<!--				<div class="col-sm-12">
				...
				<div class="col-sm-6">
					<div class="form-group">
                                            <label for="sender-email" class="font-dialog"><?php _e('Your E-mail address', 'iii-dictionary') ?></label>
						<input type="text" class="form-control" id="sender-email" name="sender-email" value="<?php echo $current_user->user_email ?>" disabled>
					</div>     
				</div>
				<div class="col-sm-6">
					<div class="form-group">
                                            <label for="sender-password" class="font-dialog"><?php _e('Your Password', 'iii-dictionary') ?></label>
				...
				<div class="col-sm-12">
					<div class="form-group">
                                            <label for="recipient" class="font-dialog"><?php echo $send_to_lbl ?></label>
				...
				<div class="col-sm-12">
					<div class="form-group">
						<label for="subject" class="font-dialog"><?php _e('Subject', 'iii-dictionary') ?></label>
						<input type="text" class="form-control" id="subject" name="subject" maxlength="100" value="<?php echo $subject ?>">
					</div>     
				</div>
<!--				<div class="col-sm-12">
					<div class="form-group">
						<label class="font-dialog"><?php _e('Message', 'iii-dictionary') ?></label>
				...
				<?php if($view == 'newpm' && !$sid) : ?>
					<div class="col-sm-12">
						<div class="form-group">
							<button type="submit" name="submit-message" class="btn-custom"><?php echo $mid ? __('Reply', 'iii-dictionary') : __('Send', 'iii-dictionary') ?></button>
						</div>
					</div>
				<?php endif ?>
			</div>
