...
<?php endif ?>
    if ((window.matchMedia('screen and (min-width: 1200px)').matches)) {
            ...
            jQuery('#spelling-practice .article-header .row').attr('style', 'width:1050px; margin:auto !important');
            jQuery('#spelling-practice .entry-content .row:first').attr('style', 'width:1050px; margin:auto !important');
        }
