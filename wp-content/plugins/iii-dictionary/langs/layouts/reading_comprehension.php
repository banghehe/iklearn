...
<script>
    if ((window.matchMedia('screen and (min-width: 1200px)').matches)) {
        ...
        jQuery('#reading-comprehension .article-header .row').attr('style', 'width:1050px; margin:auto !important');
        jQuery('#reading-comprehension .entry-content .row:first').attr('style', 'width:1050px; margin:auto !important');
    }
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="form-group">
            <label style="color: #ffd26b"><?php _e('Passage', 'iii-dictionary') ?></label>
...
<div class="row">
    <?php if ($mode == 'practice') : ?>
        <div class="col-sm-6">
            <div class="form-group">
                <button type="button" id="submit-btn" class="btn btn-block css-background-ff8a00 css-color-fff css-height-45" ><?php _e('Submit', 'iii-dictionary') ?><span class="icon-submit-new"></span></button>
            </div>
        </div>
    <?php endif ?>
    <div class="col-sm-6">
        <div class="form-group">
            <button type="button" id="next-btn" class="btn btn-block css-background-00a5bb css-color-fff css-height-45"><?php _e('Next', 'iii-dictionary') ?><span class="icon-next-new"></span></button>
        </div>
    </div>
</div>
...
<div id="require-modal1" class="modal fade modal-white ik-modal1 ik-modal-transparent" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <a href="#" data-dismiss="modal" aria-hidden="true" class="close close-dialog" style="margin-top:10px"></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="select-box-it form-control" name="sat-months" id="sel-self-study-months1">
                                    <?php for ($i = 1; $i <= 24; $i++) : ?>
...
<?php endif ?>
    (function ($) {
        $(function () {
//            // check user is view homework? if view is colum on wp_dict_homeworks -> '1'
...
//            if(url.indexOf())
            ...
            $("#next-btn").click(function () {
                ...
                if (DIS != '' && existclass == false && window.location.href.indexOf("&pr=")<=-1) {
                    ...
                    if($("#current-word").val()==(count_total-1)){
                        $('#words-pagin').html('finished');
                        if (CMODE != 'homework'){
                            var modal = $("#require-modal1");
                            modal.find("h3").text('Message');
                            modal.find(".modal-body").html('You have completed your worksheet. Would you like to go back and check again? You may change your answer.', 'iii-dictionary');
                            modal.find(".modal-footer").html('');
//                            modal.find(".modal-footer").html('<button id="btn-continue" style="width: 45%;float:left;" class="btn btn-block orange">aaaaaa</button><button id="btn-cancel" style="width: 45%;" class="btn orange">bbbb</button>');
                            modal.modal();
                        }else{
                            var modal = $("#require-modal1");
                            modal.find("h3").text('Message');
                            modal.find(".modal-body").html('You have completed your worksheet.', 'iii-dictionary');
                            modal.find(".modal-footer").html('');
                            modal.modal();
