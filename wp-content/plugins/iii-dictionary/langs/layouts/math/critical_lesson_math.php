...
if (isset($segment) && $segment[2] == 'mathteacher') {
    ...
    <div id="content" class="body-crit-lesson-math">
        <div class="txt-critical-english txt-critical-math-mb">Critical Math Subjects</div>
    ...
    <form id="lang-form" method="post" action="">
        <div  id="div_hw3" style="margin-bottom: 50px">
            <div id="homeworkcourse" style="overflow: hidden;">
                <div class="homeworkcritical-online can-scroll" style="height:492px;" >
                    <div class="width-table-display-math">
                    <table class="table table-striped table-condensed ik-table1 scroll-fix-head-new" id="homeworkcritical" >
                        <thead class="homeworkcritical" style="font-size: 15px;">
                            <tr style="height: 46px;">
                                ...
                                <th class="text-color-custom-1" style="width: 42% !important"><?php _e('', 'iii-dictionary') ?></th>
                                <th class="text-color-custom-1" style="width: 10%;padding-left: 3% !important"><?php _e('Detail', 'iii-dictionary') ?></th>
                        ...
                        <tbody style="max-height: 441px !important;font-size: 14px;">
                            <?php 
...
//                                                        var_dump($get_stg->step['id']);
                                                if (empty($get_stg->step_of_user) && $item->price != 0 || !is_user_logged_in()) { ?>
                                                    <a href="#" data-name="<?php echo $item->name ?>" data-free="<?php echo ( $item->price == 0 ) ? '1' : '0' ?>" data-price="<?php echo $item->price;?>" data-jcid="<?php echo $item->id ?>" class="bold-font btn btn-default btn-block css-color-006fbd btn-tiny btn-a-link join-class-lang-btn"><?php _e('JOIN', 'iii-dictionary') ?></a>
                                                    <?php } else { ?>
                                                    <a href="<?php echo locale_home_url() ?>?r=online-learning&math&lvid=<?php echo $item->id?>" class="bold-font btn btn-default btn-block btn-tiny css-color-006fbd btn-a-link prevent-detail-btn-<?php echo $is_math ? 'math' : 'english' ?> "><?php _e('START', 'iii-dictionary') ?></a>
                                                <?php } ?>
                                            </td>
