...
<script>
    (function ($) {
        jQuery('#my-account .article-header').css('background', '#ffffff');
        jQuery('#my-account #page-tabs-container').css('background', '#ffffff');
        jQuery('#my-account .entry-content').css('background', '#ffffff');
        jQuery('#my-account .entry-content').css('color', '#000000');
        jQuery('#page-info-tab').hide();
        jQuery('#my-account .page-title').css('color', '#000000 !important');
        jQuery('#span-title').html('Modify My Account an Register as a Student');
        jQuery('#span-title').css("padding-top","7px");
    })(jQuery);
</script>
<!--    <div class="row">
        <div class="col-xs-12">
...
<!--<p style="font-size: 19px;">follow the steps to Study online</p>-->
<h3 style="margin: 0 0 10px 0;"><?php _e('Account information', 'iii-dictionary'); ?></h3>
<div class="row">
    <!--<p><a role="button" style="color:#fff" data-toggle="collapse" href="#step1-collapse" class="step-number" title="" ><?php _e('Profile', 'iii-dictionary'); ?></a></p>-->
                ...
                <form method="post" action="<?php echo locale_home_url() ?>/?r=my-account">
                    ...
                    <div class="col-sm-12">
                        <table class="table table-striped table-condensed table-no-boder ik-table-break-all text-center table-margin-bottom " style="border: none !important;">
                            <tbody> 
                                    <tr>
                                        <td class="title-green" style="width: 34%;background: #fff"><?php _e('Point Balance:', 'iii-dictionary') ?></td>                                     
                                ...
                                <tr>
                                    <td class="content-table-noboder color-gray838383" colspan="2"><?php _e('Enter a Credit Code ( if you have any )', 'iii-dictionary') ?></td>
                                </tr>
                                <tr>
    ...
    <div id="my-acount-col7" >
        <div class="box-gray list-group-subscribe1" style="height: 400px">
            <div class="row">
                <div class="col-sm-12">
                    <p class="p-all-sub-group"><?php _e('All My Subscribed Groups', 'iii-dictionary') ?></p>
                </div>
                <div class="col-sm-12">
                    <table class="table  table-condensed  ik-table-break-all text-center scroll-fix-head" id="homeworkcritical">
                        <thead style="background: #838383">
                            <tr>
                                <th class="text-color-custom-1" style="text-align: left;width: 20%;padding-left: 5%"><?php _e('Group Name', 'iii-dictionary') ?></th>
...
<!--                                    <td style="text-align: center; width: 5%;"><?php echo ($j + 1) . '.'; ?></td>-->
                                    <td  style="text-align:left; width: 45%;padding-left: 5%"><?php _e($group_name[$j], 'iii-dictionary') ?></td>
...
<div style="padding-top:38px">
    ...
    <ul class="nav nav-tabs" id="account-purchase">
        <li id="li-purchase-1" ><a data-toggle="tab" class="a-custom-color" href="#pur-substatus"><?php _e('My Subscription Status', 'iii-dictionary'); ?></a></li>
        <li id="li-purchase-2" ><a data-toggle="tab" class="a-custom-color" href="#pur-history"><?php _e('Purchase History', 'iii-dictionary'); ?></a></li>
        <li id="li-purchase-hidden" class="active icon-tab-menu-math"><a data-toggle="tab" class="icon-hidden" id="hide-ik" href="#pur-1"></a></li>
        <li id="li-purchase-hidden-1"></li>
    </ul><div class="tab-content can-scroll">
...
<div class="padding-top-60px">
    <h3 style="margin: 0 0 10px 0;"><?php _e('Purchase Subscriptions (For yourself or as a Gift)', 'iii-dictionary'); ?></h3>
        <?php if ($is_math_panel) { ?>
    ...
    <?php if ($is_math_panel) { ?>
        <div class="row boder-bottom-1px sub-pur">
            <div class="col-xs-8 col-sm-5 col-md-6 col-lg-6 text-sub-pur"><?php _e('IK Math Classes', 'iii-dictionary'); ?></div>
        ...
        <div class="row boder-bottom-1px sub-pur">
            <div class="col-xs-8 col-sm-5 col-md-6 col-lg-6 text-sub-pur"><?php _e('SAT I Preparation', 'iii-dictionary'); ?></div>
            ...
            <div class="col-xs-12 col-sm-4 col-md-4  col-lg-4 padding-top15"><a href="" data-sat-class="SAT I Preparation" data-subscription-type="7" data-type="9" class="btn-custom choose-sub-btn" target="_blank" data-toggle="modal"><?php _e('Purchase Now', 'iii-dictionary'); ?></a></div>
        </div>
        <div class="row boder-bottom-1px sub-pur">
            <div class="col-xs-8 col-sm-5 col-md-6 col-lg-6 text-sub-pur"><?php _e('SAT I Simulated Test (New SAT Test)', 'iii-dictionary'); ?></div>
        ...
        <div class="row boder-bottom-1px sub-pur">
            <div class="col-xs-8 col-sm-5 col-md-6 col-lg-6 text-sub-pur"><?php _e('SAT II Preparation', 'iii-dictionary'); ?></div>
            ...
            <div class="col-xs-12 col-sm-4 col-md-4  col-lg-4 padding-top15"><button type="button" data-sat-class="SAT II Preparation" data-subscription-type="8" data-type="15" class="btn-custom choose-sub-btn" ><?php _e('Purchase Now', 'iii-dictionary'); ?></button></div>
        </div>
        <div class="row boder-bottom-1px sub-pur">
            <div class="col-xs-8 col-sm-5 col-md-6 col-lg-6 text-sub-pur"><?php _e('SAT II Simulated Test', 'iii-dictionary'); ?></div>
        ...
        <div class="row boder-bottom-1px sub-pur">
            <div class="col-xs-8 col-sm-5 col-md-6 col-lg-6 text-sub-pur"><?php _e('SAT practice Test ', 'iii-dictionary'); ?></div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="font-dialog col-xs-12" style="border-bottom: 1px solid #d6d6d6;"><?php _e('Selected Class', 'iii-dictionary') ?></label>
                                <p class="selected-class col-xs-12" id="selected-class" >IK Math classes</p>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-12" style="padding-top: 3%">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="font-dialog col-xs-12" style="border-bottom: 1px solid #d6d6d6;"><?php _e('Selected Class', 'iii-dictionary') ?></label>
                                <p class="selected-class col-xs-12" id="selected-class" >SAT practice Test</p>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-12" style="padding-top: 3%">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="font-dialog col-xs-12" style="border-bottom: 1px solid #d6d6d6;"><?php _e('Selected Class', 'iii-dictionary') ?></label>
                                <p class="selected-class col-xs-12" id="selected-class" >SAT I Preparation</p>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-12" style="padding-top: 3%">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="font-dialog col-xs-12" style="border-bottom: 1px solid #d6d6d6;"><?php _e('Selected Class', 'iii-dictionary') ?></label>
                                <p class="selected-class col-xs-12" id="selected-class" >SAT II Preparation</p>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-12" style="padding-top: 3%">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="font-dialog col-xs-12" style="border-bottom: 1px solid #d6d6d6;"><?php _e('Selected Class', 'iii-dictionary') ?></label>
                                <p class="selected-class col-xs-12" id="selected-class" >SAT I simulated test</p>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-12" style="padding-top: 3%">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="font-dialog col-xs-12" style="border-bottom: 1px solid #d6d6d6;"><?php _e('Selected Class', 'iii-dictionary') ?></label>
                                <p class="selected-class col-xs-12" id="selected-class" >SAT II simlated test</p>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-12" style="padding-top: 3%">
        ...
        <div class="modal-content boder-black">
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <button type="submit" id="sub-continue" class="btn-custom" data-loading-text="<?php _e('Checking...', 'iii-dictionary') ?>"><?php _e('Continue', 'iii-dictionary') ?></button>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
...
<!-- Teacher's Homework Tool Subscription continue  -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="no-students" id="student_num" class="form-control" data-min="<?php echo $min_no_of_student ?>" value="1">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
            ...
            <div class="modal-custom-first">
                <div class="body-modal">
                        <?php if ($is_math_panel) { ?>
                            ...
                            <div style="    border-bottom: 1px solid #ccc;margin-bottom: 4%"></div>
                            <p class="p-custom span-left15 color-green708b23"><?php _e('You can use all worksheets listed in this site once you subscribe "Self-study" mode. Self-study 
        ...
        <div class="modal-content boder-black">
            ...
            <div class="modal-custom-first">
                <div class="body-modal">
                    ...
                    <div style="    border-bottom: 1px solid #ccc;margin-bottom: 4%"></div>
                    <p class="p-custom span-left15 color-green708b23"><?php _e('A powerful electronic version of America’s best-selling language reference that delivers 
        ...
        <div class="modal-content boder-black">
            ...
            <div class="modal-custom-first">
                <div class="body-modal">
                    ...
                    <div style="    border-bottom: 1px solid #ccc;margin-bottom: 4%"></div>
                    <p class="p-custom span-left15 color-green708b23"><?php _e('SAT Preparation: You may join SAT preparation class at this site. Once you join, then you can 
        ...
        <div class="modal-content boder-black">
            ...
            <div class="modal-custom-first">
                <div class="body-modal">
                    ...
                    <div style="    border-bottom: 1px solid #ccc;margin-bottom: 4%"></div>
                    <p class="p-custom span-left15 color-green708b23"><?php _e('Points are required to purchase worksheet that you can use for the homework assignment.', 'iii-dictionary'); ?></p>
        ...
        <div class="modal-content boder-black">
            ...
            <div class="modal-custom-first">
                <div class="body-modal">
                    ...
                    <div style="    border-bottom: 1px solid #ccc;margin-bottom: 4%"></div>
                    <p class="p-custom span-left15 color-green708b23"><?php _e('What is the Teacher\'s Tool subscription, and what can teachers do with this subscription?', 'iii-dictionary'); ?></p>
        ...
        <div class="modal-content boder-black">
            ...
            <div class="modal-custom-first">
                <div class="body-modal">
                    ...
                    <div style="    border-bottom: 1px solid #ccc;margin-bottom: 4%"></div>
                    <p class="p-custom span-left15 color-green708b23"><?php _e('Please select the grade you subscribe and pay for one month subscription below.', 'iii-dictionary'); ?></p>
        ...
        <div class="modal-content boder-black">
            ...
            <div class="modal-custom-first">
                <div class="body-modal">
                    ...
                    <div style="    border-bottom: 1px solid #ccc;margin-bottom: 4%"></div>
                    <p class="p-custom span-left15 color-green708b23"><?php _e('This practice is essential to prepare for SAT I preparation. You will quickly review entire Algebra 
        ...
        <div class="modal-content boder-black">
            ...
            <div class="modal-custom-first">
                <div class="body-modal">
                    ...
                    <div style="    border-bottom: 1px solid #ccc;margin-bottom: 4%"></div>
                    <p class="p-custom span-left15 color-green708b23"><?php _e('This practice is essential to prepare for SAT II preparation. You will quickly review entire Algebra 
in this class.', 'iii-dictionary'); ?></p>
...
//                    $('[data-toggle="popover"]').popover($('#no-of-points'));
        ...
        if ((window.matchMedia('screen and (min-width: 1200px)').matches)) {
            ...
            jQuery('#my-account .article-header .row').attr('style', 'width:1050px; margin:auto !important');
            jQuery('#my-account .entry-content .row:first').attr('style', 'width:1050px; margin:auto !important');
        }
