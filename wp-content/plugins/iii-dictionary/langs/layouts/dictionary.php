...
<header class="article-header header-bacground" style="height: 88px;">
    <div class="row">
        <div class="dictionary-width col-sm-offset-1">								
            <div class="row">
...
<section class="entry-content dictionary">
                        ...
                        if ($pronunciation) :
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-10 pr" style="width: 100%">
                                    ...
                                    <a class='go-to-vb' href="<?php locale_home_url()?>/?r=flash-cards">Go to Vocabulary Builder</a>
                                </div>
                            </div>
                        <?php endif ?>
