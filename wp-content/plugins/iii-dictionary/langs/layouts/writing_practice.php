...
<script>
    if ((window.matchMedia('screen and (min-width: 1200px)').matches)) {
        ...
        jQuery('#writing-practice .article-header .row').attr('style', 'width:1050px; margin:auto !important');
        jQuery('#writing-practice .entry-content .row:first').attr('style', 'width:1050px; margin:auto !important');
    }
