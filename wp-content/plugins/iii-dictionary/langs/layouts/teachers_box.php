<?php
	...
	$_page_title = __('Teacher\'s Box', 'iii-dictionary');
...
<form method="post" action="<?php echo locale_home_url() . '/?r=teachers-box' ?><?php echo $gid ? '&amp;gid=' . $gid : '' ?>" id="main-form">
	<div class="row">
		...
		<?php if(!$gid) : ?>
			...
			<div class="col-sm-12">
				<h2 class="title-border"><?php _e('List of Group/Class', 'iii-dictionary') ?></h2>
			</div>
			<div class="col-sm-12">
				<div class="box box-sapphire">
					<div class="row box-header">
						...
						<?php if($is_admin) : ?>
							<div class="col-sm-4">
								<div class="form-group">
									<select name="filter[class-types]" class="select-box-it select-sapphire form-control">
  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		...
		<?php else : if(!$hid) : ?>
			<div class="col-sm-12">
				<h2 class="title-border"><?php printf(__('List of Homeworks assigned to Group %s', 'iii-dictionary'), $assignments->items[0]->group_name) ?></h2>
			</div>
			...
			<div class="col-sm-4 col-sm-offset-8" style="margin-top: 20px">
				<div class="form-group">
					<a href="<?php echo locale_home_url() ?>/?r=teachers-box" class="btn btn-default grey form-control"><span class="icon-goback"></span><?php _e('Go back', 'iii-dictionary') ?></a>
				</div>
			</div>
