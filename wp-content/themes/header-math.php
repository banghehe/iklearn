...
<!--<![endif]-->
    ...
    <head>
        ...
        <script>
            ...
            var home_url_english = "<?php echo site_home_url();?>";
        </script>
        ...
        <div id="container">
            <header class="header header-math" itemscope itemtype="http://schema.org/WPHeader">
                ...
                <div class="container" style="position: relative">
                    ...
                    <div id="header-math" class="cs-button-math active">
                    ...
                    <?php if ($is_user_logged_in){ ?>
                    <ul id="user-nav" class="css-pad-log-math">
                    <?php }else{ ?>
	                <ul id="user-nav" class="css-pad-nolog-math">
	                <?php } ?>
                    <?php if ($is_user_logged_in) : ?>
                    ...
                    <?php if (!$is_user_logged_in) : ?>
                        <li class="css-li-login">
                            <a href="<?php echo locale_home_url() ?>/?r=login" id="show_login" title="<?php _e('Login', 'iii-dictionary') ?>">
                                <?php _e('Login', 'iii-dictionary') ?><span class="login-icon"></span></a>
                        </li>
                        <li class="">
                            <a class="sign-up-link" id="show_signup" href="<?php echo locale_home_url() ?>/?r=signup" title="<?php _e('Sign-up', 'iii-dictionary') ?>">
                    ...
                    <div id="main-nav" class="row">
                        ...
                        <nav class="navbar navbar-default css-menu-math">
                            <?php 
                            wp_nav_menu(array(
                        ...
                        <nav class="navbar navbar-default css-menu-student-myaccount" id="sub-user-nav">
                            <?php 
                            wp_nav_menu(array(
								 'container' => false,                           // remove nav container
								 'container_class' => '',                 // class of container (should you choose to use it)
