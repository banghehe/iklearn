    ...
    <div id="container">
        <header class="header" itemscope itemtype="http://schema.org/WPHeader">
            ...
            <div class="container" style="position: relative">
                ...
                <div id="header-math" class="cs-button-math <?php if($segment[2] == 'home' || (isset($route[0]) && $route[0] != 'ensat')) echo 'active'?>">
                ...
                <!-- Menu horizotal    -->
                <nav class="navbar navbar-default" id="menu-horizontal-math">
                        <?php 
                        wp_nav_menu(array(
                            'container' => false,                           // remove nav container
                            'container_class' => '',                 // class of container (should you choose to use it)
                            'menu' => 'Main Menu Math',  // nav name
                            'menu_class' => 'main-menu nav navbar-nav menu-math',               // adding custom nav class
                            'theme_location' => 'main-nav-math',                 // where it's located in the theme
                            'before' => '',                                 // before the menu
                            'after' => '',                                  // after the menu
                            'link_before' => '',                            // before each link
                            'link_after' => '',                             // after each link
                    ...
                    <!-- Sub Menu horizotal    -->
                    <nav class="navbar navbar-default" id="sub-menu-horizontal-math">
                        <?php 
                        wp_nav_menu(array(
                            'container' => false,                           // remove nav container
                            'container_class' => '',                 // class of container (should you choose to use it)
                            'menu' => 'Function Menu',  // nav name
                            'menu_class' => 'user-nav nav navbar-nav',               // adding custom nav class
                            'theme_location' => 'math-user-nav',                 // where it's located in the theme
                            'before' => '',                                 // before the menu
                            'after' => '',                                  // after the menu
                            'link_before' => '',                            // before each link
                            'link_after' => '',                             // after each link
